...
const haushaltsbuch = {
  ...
  html_gesamtbilanz_generieren() {
    ...
    einnahmen_betrag.textContent = `${(this.gesamtbilanz.get('einnahmen') / 100)
      .toFixed(2)
      .replace(/\./, ',')} €`;
    ...
    ausgaben_betrag.textContent = `${(this.gesamtbilanz.get('ausgaben') / 100)
      .toFixed(2)
      .replace(/\./, ',')} €`;
    ...
    bilanz_betrag.textContent = `${(this.gesamtbilanz.get('bilanz') / 100)
      .toFixed(2)
      .replace(/\./, ',')} €`;
  ...
  gesamtbilanz_anzeigen() {
    document
      .querySelectorAll('#gesamtbilanz')
      .forEach((gesamtbilanz) => gesamtbilanz.remove());
    document
      .querySelector('body')
